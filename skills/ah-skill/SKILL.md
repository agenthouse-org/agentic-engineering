...
Import only the specified reviewed source. Required frontend-acceptance is managed through dependencies, not a second editable import.

CLI reference:

```text
skill --source DIRECTORY [--name ID] [--sha256 HASH]
