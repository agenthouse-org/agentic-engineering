...
Inspect the actual target repository before proposing commands. Report discovered tooling and uncertainty. The survey does not execute scripts or enroll the project.
