...
import {verifyDependency} from '../src/dependencies.js';
const [repo,revision,output]=process.argv.slice(2);
...
const sourcePath='engineering/frontend-acceptance';
...
const data={schemaVersion:1,kind:'skill',id:'frontend-acceptance',version:entry.match(/^version:\s*(.+)$/m)?.[1].trim(),source:{repository:'https://github.com/agenthouse-org/skills.git',commit,path:sourcePath},license:'MIT',digest:hash(hashes),files};
