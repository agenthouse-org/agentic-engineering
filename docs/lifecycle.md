...
| design | `decisions`: chosen approach, alternatives, inherited ADRs, risks and exceptions |
...
| release | `releasePlan`, `rollbackPlan`: target, deployment sequence, recovery trigger and method |
