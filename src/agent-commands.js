...
const descriptions={
  ...
  session:'Record the active runtime and dependency versions and apply configured approved updates. Use at task start, or when checking which agenthouse version this project is running.',
